<template>
    <canvas ref="canvas" @click="draw" width="140" height="40" style="cursor: pointer;border-radius: 5px; border: 1px solid #cfcfcf"></canvas>
</template>
<script>
export default {
    data() {
    ...
    mounted() {
        this.draw();
        // this.$emit('getValidcode',this.codes.join())
    ...
    methods: {
        ...
        drawText() {
            ...
            // this.ctx.fillStyle = "rgba(180, 247, 238)";
